...
class ProfilesController extends Controller
{
    private $rules = [
        ...
        'alternative_firstname'     => 'required|max:191',
        'alternative_lastname'      => 'required|max:191',
        ...
        'url1'                      => 'required|min:5|max:191',
        'url2'                      => 'required|min:5|max:191',
        'url3'                      => 'required|min:5|max:191',
        'primary_domain_word'       => 'required|min:3|max:191',
        'secondary_domain_word'     => 'required|min:3|max:191',
