            ...
            <div class="portlet light bg-inverse">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red-sunglo bold uppercase">Edit user form</span>
                    </div>
                </div>
                @include('errors')
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{Form::open(['route' => ['users.update', $user->id], 'method' => 'put', 'id' => 'edit_users_form', 'files' => true, 'class' => 'horizontal-form'])}}
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::select('role', $roles, $user->role, ['data-placeholder' => 'Choose a Role', 'class' => 'form-control', 'tabindex' => 1])}}
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" id="password" value="" maxlength="25" class="form-control" placeholder="Password">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                        <input type="checkbox" name="is_active" @if ($user->is_active) checked @endif class="make-switch" id="is_active">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
