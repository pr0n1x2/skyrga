...
<div id="target">
    <div class="note note-info">
        <h3 class="page-title"> @if(!$activeTargetID) <i class="fa fa-check-circle font-green-jungle"></i> @endif Registration process </h3>
        @if($activeTargetID)
            <p> <strong>Now selected:</strong> <span>{{$activeTargetStr}}</span> </p>
        @else
                            ...
                            <li>
                                <div class="col1">
                                    <div class="cont target-radio">
                                        ...
                                        <div class="cont-col2">
                                            <div class="desc"> {{$target->profile->name}} ({{$target->profile->domain}}) </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col2">
                                    <div class="info">
                                        <a href="javascript:;" class="copy-data copy-email"><i class="fa fa-envelope font-yellow-casablanca"></i></a>
                                        <a href="javascript:;" class="email account-show" data-item="{{$target->getEmailID()}}">{{$target->getEmail()}}</a>
                                    </div>
                                </div>
                                <div class="col3">
                                    <div class="info">
                                        <a href="javascript:;" class="copy-data copy-username"><i class="fa fa-user font-yellow-casablanca"></i></a>
                                ...
                                <div class="col4">
                                    <div class="info">
                                        @if(!empty($target->account->password))
                                            <a href="javascript:;" class="copy-data copy-password"><i class="fa fa-unlock-alt font-yellow-casablanca"></i></a>
                                            <span>{{$target->account->password}}</span>
                                        @else
                                            <i class="fa fa-unlock-alt font-yellow-mint"></i>
