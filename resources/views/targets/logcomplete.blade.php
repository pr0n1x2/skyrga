...
@section('title', 'Authorization is complete')
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content ubot-full-width">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Authorization is complete </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                <div class="note note-success">
                    <p> Congratulations, successfully login to profile &quot;{{$target->profile->name }} ({{($target->profile->domain)}})&quot;.</p>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-arrow-circle-o-right"></i>Continue Authorization </div>
                        </div>
                        <div class="portlet-body">
