                                ...
                                <!-- BEGIN FORM-->
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label label-bold">Primary Subdomains</label>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/row-->
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Subdomains 1:</label>
                                                    <span class="not_editable">{{$target->profile->primary_domain_word}}</span>
                                                    <a href="javascript:;" class="btn btn-xs default copy-data copy-attr" data-field="subdomain1">
                                                        <i class="fa fa-clipboard"></i> copy
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Subdomains 2:</label>
                                                    <span class="not_editable">{{$target->profile->secondary_domain_word}}</span>
                                                    <a href="javascript:;" class="btn btn-xs default copy-data copy-attr" data-field="subdomain2">
                                                        <i class="fa fa-clipboard"></i> copy
                                                    </a>
                                                </div>
                                            </div>
