            ...
            <div class="portlet light bg-inverse">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red-sunglo bold uppercase">Create new post form</span>
                    </div>
                </div>
                @include('errors')
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{Form::open(['route' => 'posts.store', 'id' => 'posts_form', 'class' => 'horizontal-form'])}}
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="title" id="title" class="form-control" placeholder="Spin Title" rows="6">{{old('title')}}</textarea>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="text" id="text" class="form-control" placeholder="Spin Text" rows="20">{{old('text')}}</textarea>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="anchor1" id="anchor1" class="form-control" placeholder="Spin Anchor #1" rows="6">{{old('anchor1')}}</textarea>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="anchor2" id="anchor2" class="form-control" placeholder="Spin Anchor #2" rows="6">{{old('anchor2')}}</textarea>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="anchor3" id="anchor3" class="form-control" placeholder="Spin Anchor #3" rows="6">{{old('anchor3')}}</textarea>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="anchor4" id="anchor4" class="form-control" placeholder="Spin Anchor #4" rows="6">{{old('anchor4')}}</textarea>
                                </div>
                            </div>
                            <!--/span-->
                        </div>
