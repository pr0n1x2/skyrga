                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                        <input type="checkbox" name="use_default_user_profile" @if (old('use_default_user_profile')) checked @endif class="make-switch" id="use_default_user_profile">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="heading_frame" id="heading_frame" value="{{old('heading_frame')}}" maxlength="191" class="form-control" placeholder="Heading frame">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
