                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                        <input type="checkbox" name="is_use_proxy_in_post" @if ($project->is_use_proxy_in_post) checked @endif class="make-switch" id="is_use_proxy_in_post">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                        <input type="checkbox" name="is_use_link_from_article" @if ($project->is_use_link_from_article) checked @endif class="make-switch" id="is_use_link_from_article">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                        <input type="checkbox" name="is_use_general_anchors" @if ($project->is_use_general_anchors) checked @endif class="make-switch" id="is_use_general_anchors">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                        <input type="checkbox" name="is_use_main_anchors" @if ($project->is_use_main_anchors) checked @endif class="make-switch" id="is_use_main_anchors">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
