...
@section('content')
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title"> Create New Group Page </h3>
            <!-- END PAGE TITLE-->
            <!-- BEGIN PAGE BAR -->
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Create New Group Page</span>
                    </li>
                </ul>
            ...
            <div class="portlet light bg-inverse">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red-sunglo bold uppercase">Create new group form</span>
                    </div>
                </div>
                @include('errors')
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{Form::open(['route' => 'groups.store', 'id' => 'groups_form', 'class' => 'horizontal-form'])}}
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" value="{{old('name')}}" maxlength="60" class="form-control" placeholder="Name">
                                </div>
                            </div>
                            <!--/span-->
                        </div>
