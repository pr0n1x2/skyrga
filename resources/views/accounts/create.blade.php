...
@section('content')
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <!-- BEGIN PAGE HEADER-->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title"> Create New Account Page </h3>
            <!-- END PAGE TITLE-->
            <!-- BEGIN PAGE BAR -->
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>Create New Account Page</span>
                    </li>
                </ul>
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li>
                                <a href="{{route('accounts.index')}}">
                                    <i class="icon-action-undo"></i> Back to Public Accounts</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="portlet light bg-inverse">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red-sunglo bold uppercase">Create new account form</span>
                    </div>
                </div>
                @include('errors')
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{Form::open(['route' => 'accounts.store', 'id' => 'accounts_form', 'class' => 'horizontal-form'])}}
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::select('mail_account_id', $reserveEmails, old('mail_account_id'), ['placeholder' => 'Pick a E-mail Account', 'class' => 'form-control', 'tabindex' => 1])}}
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::select('gender', ['male' => 'Male', 'female' => 'Female'], old('gender'), ['placeholder' => 'Pick a Gender', 'class' => 'form-control', 'tabindex' => 2])}}
                                </div>
                            </div>
                            <!--/span-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="prefix" id="prefix" value="{{old('prefix')}}" maxlength="10" class="form-control" placeholder="Ms. or Mr.">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" id="phone" value="{{old('phone')}}" maxlength="20" class="form-control" placeholder="+1(123)-123-6789">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="domain_word" id="domain_word" value="{{old('domain_word')}}" maxlength="40" class="form-control" placeholder="Domain word">
                                </div>
                            </div>
                            <!--/span-->
                        </div>
